...
type FakeShardingConfigs struct {
	Fake *FakeKridgeV1alpha1
	ns   string
}

var shardingconfigsResource = schema.GroupVersionResource{Group: "kridge.kusionstack.io", Version: "v1alpha1", Resource: "shardingconfigs"}

var shardingconfigsKind = schema.GroupVersionKind{Group: "kridge.kusionstack.io", Version: "v1alpha1", Kind: "ShardingConfig"}
