...
// NewForConfigAndClient creates a new CtrlmeshV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CtrlmeshV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &CtrlmeshV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CtrlmeshV1alpha1Client for the given config and
...
func New(c rest.Interface) *CtrlmeshV1alpha1Client {
	return &CtrlmeshV1alpha1Client{c}
}
