	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CtrlmeshV1alpha1().CircuitBreakers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CtrlmeshV1alpha1().CircuitBreakers(namespace).Watch(context.TODO(), options)
			},
		},
		&ctrlmeshv1alpha1.CircuitBreaker{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *circuitBreakerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ctrlmeshv1alpha1.CircuitBreaker{}, f.defaultInformer)
}

func (f *circuitBreakerInformer) Lister() v1alpha1.CircuitBreakerLister {
	return v1alpha1.NewCircuitBreakerLister(f.Informer().GetIndexer())
}
