...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FaultInjectionSnapshot.
...
func (in *FaultInjectionStatus) DeepCopyInto(out *FaultInjectionStatus) {
	*out = *in
	...
	if in.TargetStatus != nil {
		in, out := &in.TargetStatus, &out.TargetStatus
		*out = make([]*FaultInjectionTargetStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(FaultInjectionTargetStatus)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FaultInjectionTargetStatus) DeepCopyInto(out *FaultInjectionTargetStatus) {
	*out = *in
	if in.FaultInjectionSnapshots != nil {
		in, out := &in.FaultInjectionSnapshots, &out.FaultInjectionSnapshots
		*out = make([]*FaultInjectionSnapshot, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(FaultInjectionSnapshot)
...
func (in *FaultInjectionTargetStatus) DeepCopy() *FaultInjectionTargetStatus {
	if in == nil {
		return nil
	}
	out := new(FaultInjectionTargetStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MutiRestRule) DeepCopyInto(out *MutiRestRule) {
	*out = *in
	if in.URL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MutiRestRule.
func (in *MutiRestRule) DeepCopy() *MutiRestRule {
	if in == nil {
		return nil
	}
	out := new(MutiRestRule)
	in.DeepCopyInto(out)
	return out
}
