...
// DeepCopyInto supports using MutiRestRule within kubernetes types, where deepcopy-gen is used.
func (in *MutiRestRule) DeepCopyInto(out *MutiRestRule) {
	p := proto.Clone(in).(*MutiRestRule)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MutiRestRule. Required by controller-gen.
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new MutiRestRule. Required by controller-gen.
func (in *MutiRestRule) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
